...
public class MChessBoard extends ChessBoard {
    ...
    private Vector direction; // Orientation of the board
    ...
    public MChessBoard(Location originCorner, int size, Player player, Material whiteFieldMaterial, Material blackFieldMaterial) {
        ...
        this.direction = this.getBoardDirection(player);
        updateOriginCorner();
    ...
    /**
     * Retrieves the direction vector representing the orientation of the chessboard.
     *
     * @return The direction vector of the chessboard.
     */
    ...
    /**
     * Sets the direction vector representing the orientation of the chessboard.
     *
     * @param direction The new direction vector for the chessboard.
     */
