...
public class Level7 extends Level {
    ...
    public Level7(boolean console, Player player, Tutorial parent) {
        this(console, player, new Location(player.getWorld(), -127, -7, -68),
                new Location(player.getWorld(), -127, -8, -68), parent);
    }
    ...
    protected void initializeSteps() {
        ...
        setupStep.setNext(new Step(
                ...
                unused -> {
                    int Kcount = 0;
                    int Qcount = 0;
                    if (console)System.out.println("Condition: chessBoards[0].getPieces().size() = "+chessBoards[0].getPieces().size()+" < 2");
                    if(chessBoards[0].getPieces().size() < 2) return false;
                    for (Piece p : chessBoards[0].getPieces()) {
                        ...
                        if(p.getLetter() == 'K')Kcount++;
                        if(p.getLetter() == 'Q')Qcount++;
                        if (console) {
        ...
        setupStep.setNext(new Step(
                () -> {
                    ...
                    //player.getWorld().strikeLightning(new Location(player.getWorld(), -123, -8, -93));
