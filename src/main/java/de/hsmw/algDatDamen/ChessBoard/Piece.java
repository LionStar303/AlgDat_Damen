 ...
 * including its position and methods to check collisions, equality, and to
 * retrieve
...
public class Piece {
    ...
    /**
     * Default constructor that initializes the piece at the default position (0,
     * 0).
     */
    public Piece() {
        this.x = 0;
     ...
     * @return True if both pieces have the same x and y coordinates, false
     *         otherwise.
     */
     ...
     *
     * This method is intended to be overridden in subclasses for specific piece
     * types.
     *
